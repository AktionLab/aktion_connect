Feature: Connect to a confgiured service
  ...
  Scenario: Establish a connection to a configured service using an override config
    Given the service has a default config
  ...
  Scenario: Establish a connection to a configured service using an override with environment
    Given the service has a default config with environments
